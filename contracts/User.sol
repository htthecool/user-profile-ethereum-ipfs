...
contract User {
    ...
    //initializing a dynamic array to store ethereum addresses
    address[] private addresses;
    //initialize a dynamic array of 16 byte value to store usernames
    bytes16[] private usernames;
    //initialize a dynamic array to store ipfsHashes
    ...
    {
        //validate if user doesn't exist and the username is not taken
